...
| `audio.mode` | Режим главной | список | off · soundscape |  |
...
| `editorCursor` | Курсор в редакторе | список | system · dot | false |
| `editorFlashlight` | Фонарь в редакторе | выключатель | да / нет |  |
...
| `plantingBeds[].cover.plants.leaf` | Копытник в ведомости | список |  |  |
| `plantingBeds[].cover.plants.thyme` | Тимьян в ведомости | список |  |  |
...
| `topiaryObjects[].fenceSmooth` | Плавный сплайн | выключатель | да / нет |  |
| `topiaryObjects[].fenceStyle` | Конструкция | список | none · mesh-2d · mesh-358 · palisade |  |
| `topiaryObjects[].foliageVisible` | Стриженая зелень | выключатель | да / нет |  |
| `topiaryObjects[].height` | Высота | число | 0.3 … 12, шаг 0.05,  m |  |
| `topiaryObjects[].leafSize` | Размер веточки | число | 0.14 … 0.55, шаг 0.01,  m |  |
| `topiaryObjects[].perMetre` | Растений на п.м. | число | 0 … 12, шаг 0.5,  шт/п.м. |  |
| `topiaryObjects[].plant` | Растение изгороди | список |  |  |
...
| Ключ | Что это | Вид | Пределы | Заводское |
|---|---|---|---|---|
| `fireBurn` | Время горения места | число | 0 … 120, шаг 0.5, s | 7 |
| `fireColorCool` | Цвет языков | цвет | #rrggbb | #ff4d0f |
| `fireColorHot` | Цвет ядра | цвет | #rrggbb | #fff1c2 |
| `fireDelay` | Задержка поджига | число | 0 … 60, шаг 0.1, s | 1 |
| `fireEditPoint` | Ручка в сцене | список | 0 · 1 · 2 · 3 · 4 · 5 · 6 | 0 |
| `fireEnabled` | Огонь | выключатель | да / нет | false |
| `fireHeight` | Высота | число | 0.2 … 6, шаг 0.05, m | 1.3 |
| `fireIntensity` | Яркость | число | 0 … 4, шаг 0.05, × | 1 |
| `fireLight` | Свет от огня | выключатель | да / нет | true |
| `fireLightDistance` | Дальность света | число | 2 … 80, шаг 0.5, m | 16 |
| `fireLightIntensity` | Сила света | число | 0 … 400, шаг 1 | 60 |
| `fireLoop` | Повторять | выключатель | да / нет | true |
| `fireLoopPause` | Пауза перед повтором | число | 0 … 120, шаг 0.5, s | 5 |
| `fireP10X` | Точка 10 · поперёк X | число | -60 … 60, шаг 0.1, m | 1.5 |
| `fireP10Z` | Точка 10 · вдоль Z | число | -60 … 60, шаг 0.1, m | 44 |
| `fireP11X` | Точка 11 · поперёк X | число | -60 … 60, шаг 0.1, m | 1.5 |
| `fireP11Z` | Точка 11 · вдоль Z | число | -60 … 60, шаг 0.1, m | 50 |
| `fireP12X` | Точка 12 · поперёк X | число | -60 … 60, шаг 0.1, m | 1.5 |
| `fireP12Z` | Точка 12 · вдоль Z | число | -60 … 60, шаг 0.1, m | 56 |
| `fireP1X` | Точка 1 · поперёк X | число | -60 … 60, шаг 0.1, m | -2.5 |
| `fireP1Z` | Точка 1 · вдоль Z | число | -60 … 60, шаг 0.1, m | -20 |
| `fireP2X` | Точка 2 · поперёк X | число | -60 … 60, шаг 0.1, m | 1.5 |
| `fireP2Z` | Точка 2 · вдоль Z | число | -60 … 60, шаг 0.1, m | -12 |
| `fireP3X` | Точка 3 · поперёк X | число | -60 … 60, шаг 0.1, m | 2.5 |
| `fireP3Z` | Точка 3 · вдоль Z | число | -60 … 60, шаг 0.1, m | -4 |
| `fireP4X` | Точка 4 · поперёк X | число | -60 … 60, шаг 0.1, m | -1.5 |
| `fireP4Z` | Точка 4 · вдоль Z | число | -60 … 60, шаг 0.1, m | 4 |
| `fireP5X` | Точка 5 · поперёк X | число | -60 … 60, шаг 0.1, m | -2.5 |
| `fireP5Z` | Точка 5 · вдоль Z | число | -60 … 60, шаг 0.1, m | 12 |
| `fireP6X` | Точка 6 · поперёк X | число | -60 … 60, шаг 0.1, m | 1.5 |
| `fireP6Z` | Точка 6 · вдоль Z | число | -60 … 60, шаг 0.1, m | 20 |
| `fireP7X` | Точка 7 · поперёк X | число | -60 … 60, шаг 0.1, m | 1.5 |
| `fireP7Z` | Точка 7 · вдоль Z | число | -60 … 60, шаг 0.1, m | 26 |
| `fireP8X` | Точка 8 · поперёк X | число | -60 … 60, шаг 0.1, m | 1.5 |
| `fireP8Z` | Точка 8 · вдоль Z | число | -60 … 60, шаг 0.1, m | 32 |
| `fireP9X` | Точка 9 · поперёк X | число | -60 … 60, шаг 0.1, m | 1.5 |
| `fireP9Z` | Точка 9 · вдоль Z | число | -60 … 60, шаг 0.1, m | 38 |
| `firePointCount` | Точек | число | 2 … 12, шаг 1 | 6 |
| `fireScale` | Масштаб | число | 0.1 … 6, шаг 0.01, × | 1 |
| `fireSmoke` | Дым | выключатель | да / нет | true |
| `fireSmokeAmount` | Количество | число | 0 … 4, шаг 0.05, × | 1 |
| `fireSmokeColor` | Цвет | цвет | #rrggbb | #3b3634 |
| `fireSmokeLife` | Жизнь | число | 1 … 30, шаг 0.5, s | 8 |
| `fireSmokeOpacity` | Плотность | число | 0 … 1, шаг 0.01 | 0.4 |
| `fireSmokeRise` | Подъём | число | 0.2 … 6, шаг 0.1, m/s | 1.4 |
| `fireSmokeSize` | Размер клуба | число | 0.3 … 6, шаг 0.1, m | 1.6 |
| `fireSmokeWind` | Доля ветра берега | число | 0 … 3, шаг 0.05, × | 1 |
| `fireSootFade` | Копоть сходит за | число | 0 … 600, шаг 5, s | 0 |
| `fireSpeed` | Скорость фронта | число | 0.2 … 40, шаг 0.1, m/s | 4 |
| `fireTrack` | Колея и копоть | выключатель | да / нет | true |
| `fireTrackDark` | Темнота следа | число | 0 … 1, шаг 0.01 | 0.7 |
| `fireTurbulence` | Турбулентность | число | 0 … 2, шаг 0.05 | 0.6 |
| `fireWidth` | Ширина колеи | число | 0.1 … 4, шаг 0.05, m | 0.55 |
| `fireX` | Восток / запад · X | число | -400 … 400, шаг 0.1, m | 25 |
| `fireYaw` | Поворот | число | -180 … 180, шаг 1, ° | 0 |
| `fireZ` | Юг / север · Z | число | -400 … 400, шаг 0.1, m | 0 |
