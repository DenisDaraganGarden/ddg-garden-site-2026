...
const file = path.resolve(process.argv[2] ?? path.join(process.cwd(), 'public/models/seagull/seagull-flight.glb'));
...
assert.equal(json.skins[0].joints.length, 23, 'expected 22 authored bones plus neutral helper');
