...
export const ASSET_CATALOG = Object.freeze([
  ...
  { index: '07', id: 'oleaster', group: 'greenery', ru: 'Куст', en: 'Shrub', title: { ru: 'Лох узколистный · куст', en: 'Oleaster shrub' } },
  { index: '08', id: 'tree', group: 'greenery', ru: 'Дерево', en: 'Tree', title: { ru: 'Лох узколистный · дерево', en: 'Oleaster tree' } },
  { index: '09', id: 'lilies', group: 'greenery', ru: 'Кувшинки', en: 'Lilies', title: { ru: 'Кувшинки', en: 'Water lilies' } },
  { index: '10', id: 'algae', group: 'greenery', ru: 'Водоросли', en: 'Algae', title: { ru: 'Водоросли', en: 'Algae' } },
  { index: '11', id: 'grass', group: 'greenery', ru: 'Травы', en: 'Grasses', title: { ru: 'Травы Азовского берега', en: 'Azov coast grasses' } },
  { index: '12', id: 'topiary', group: 'greenery', ru: 'Изгородь', en: 'Topiary', title: { ru: 'Стриженые формы', en: 'Topiary' } },
  { index: '13', id: 'rocks', group: 'landscape', ru: 'Камни', en: 'Rocks', title: { ru: 'Камни · валуны, осыпь, галька', en: 'Rocks · boulders, debris, pebbles' } },
  { index: '14', id: 'driftwood', group: 'landscape', ru: 'Коряги', en: 'Driftwood', title: { ru: 'Коряги и камни', en: 'Driftwood & stones' } },
  { index: '15', id: 'water', group: 'landscape', ru: 'Море', en: 'Sea', title: { ru: 'Море · волны, прибой и пена', en: 'Sea · waves, surf and foam' } },
  { index: '16', id: 'clouds', group: 'atmosphere', ru: 'Облака', en: 'Clouds', title: { ru: 'Живописные облака', en: 'Painterly clouds' } },
]);
