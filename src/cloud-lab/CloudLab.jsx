  ...
  return <LabShell
    ...
    panel={<>
      ...
      {tab === 'storm' && <>
        ...
        {range('storm', t.stormStrength, 0, 1, .01)}{range('rain', t.rain, 0, 1, .01)}{range('lightning', t.lightning, 0, 1, .01)}
