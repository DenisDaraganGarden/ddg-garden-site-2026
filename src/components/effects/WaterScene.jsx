  ...
  return (
    <CloudSceneContext.Provider value={cloudSceneRef}>
      ...
      >
        ...
        {settings.plantingEnabled && (settings.plantingBeds?.length || settings.plantingPoints?.length) ? <PlantingLayer settings={settings} selectedBedId={mode === 'editor' ? editorGizmo?.planting?.selectedId : null} envMapIntensity={lighting.environment.reflection} /> : null}
