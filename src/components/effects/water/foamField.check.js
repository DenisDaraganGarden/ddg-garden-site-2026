...
assert.ok(breaking.includes('waterSeaFoamCoverage = mix(crest * 0.9, memory.x, memory.z);'), 'the breaker carries the sea\'s foam exactly as the open water beside it does');
