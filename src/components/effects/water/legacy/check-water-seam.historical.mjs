// Historical finite-pond/far-water overlap check. Archived for comparison only;
// its assertions describe retired visual surfaces and it is intentionally not runnable.
