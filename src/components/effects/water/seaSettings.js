...
export const SEA_SETTINGS_DEFAULTS = Object.freeze({
  ...
  seaSprayAmount: 1, seaSpraySize: 1, seaSprayStreak: 1, seaSprayCurtain: 0.4, seaSprayLife: 2.2, seaSprayDensity: 1.3, seaSpraySpread: 1.6,
  // The puffs of spray, apart from the drops: how many where the lip lands and
  // behind the wave, and their own size, density, life, rise and growth.
  seaSprayPuffSplash: 1, seaSprayPuffTrail: 1, seaSprayPuffSize: 2.2, seaSprayPuffDensity: 1, seaSprayPuffLife: 2.2, seaSprayPuffLift: 0.85, seaSprayPuffGrow: 1,
  seaSwashFilm: 0.03,
});
...
export const SEA_RANGES = Object.freeze({
  ...
  seaSprayAmount: [0, 6, 0.05], seaSpraySize: [0.3, 3, 0.05], seaSprayStreak: [0, 4, 0.05], seaSprayCurtain: [0, 1, 0.01], seaSprayLife: [0.5, 6, 0.1], seaSprayDensity: [0.2, 3, 0.05], seaSpraySpread: [0, 8, 0.1],
  seaSprayPuffSplash: [0, 10, 0.05], seaSprayPuffTrail: [0, 10, 0.05], seaSprayPuffSize: [0.3, 12, 0.1], seaSprayPuffDensity: [0, 6, 0.05], seaSprayPuffLife: [0.3, 12, 0.1], seaSprayPuffLift: [0, 4, 0.05], seaSprayPuffGrow: [0, 1, 0.01],
});
...
export function resolveSeaSettings(flat = {}) {
  ...
  return {
    ...
    sprayPuffSplash: sea.seaSprayPuffSplash, sprayPuffTrail: sea.seaSprayPuffTrail, sprayPuffSize: sea.seaSprayPuffSize, sprayPuffDensity: sea.seaSprayPuffDensity, sprayPuffLife: sea.seaSprayPuffLife, sprayPuffLift: sea.seaSprayPuffLift, sprayPuffGrow: sea.seaSprayPuffGrow,
  };
}
