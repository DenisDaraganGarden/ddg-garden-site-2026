...
const paths = {
    ...
    // Прожектор сцены: фонарь на ножке и конус света — не лампа светильника.
    spot: <><rect x="4" y="5" width="9" height="7" rx="1.5" transform="rotate(-20 8.5 8.5)"/><path d="M8.5 12.5V21m-3 0h6"/><path d="m14.5 5 6-2m-5.5 5.5 6.5.5m-7 3 5 3.5"/></>,
    // Трассировка: луч от источника с двумя отражениями.
    trace: <><circle cx="4.5" cy="5" r="2"/><path d="M6.2 6.4 11 16l4-9 5.5 11"/><path d="M3 21h18" strokeDasharray="1.5 2"/></>,
