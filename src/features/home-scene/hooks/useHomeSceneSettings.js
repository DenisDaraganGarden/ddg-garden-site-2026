...
const normalizeHomeSceneSettings = (savedSettings = {}, includeCameraSystem = true) => {
  ...
  const normalizedScene = {
    ...
    sculptureLayering: clampFloat(merged.sculptureLayering, 0, 1, defaults.sculptureLayering),
    sculptureLayerScale: clampFloat(merged.sculptureLayerScale, 0.35, 4.5, defaults.sculptureLayerScale),
    sculptureLayerRelief: clampFloat(merged.sculptureLayerRelief, 0, 1, defaults.sculptureLayerRelief),
    sculptureLayerSharpness: clampFloat(merged.sculptureLayerSharpness, 0, 1, defaults.sculptureLayerSharpness),
    sculptureLayerEdgeChips: clampFloat(merged.sculptureLayerEdgeChips, 0, 1, defaults.sculptureLayerEdgeChips),
    sculptureFracture: clampFloat(merged.sculptureFracture, 0, 1, defaults.sculptureFracture),
    sculptureFractureScale: clampFloat(merged.sculptureFractureScale, 0.35, 4.5, defaults.sculptureFractureScale),
    sculptureVeins: clampFloat(merged.sculptureVeins, 0, 1, defaults.sculptureVeins),
    sculptureVeinScale: clampFloat(merged.sculptureVeinScale, 0.35, 4.5, defaults.sculptureVeinScale),
    sculpturePolish: clampFloat(merged.sculpturePolish, 0, 1, defaults.sculpturePolish),
    sculptureWearScale: clampFloat(merged.sculptureWearScale, 0.35, 4.5, defaults.sculptureWearScale),
    sculptureWetness: clampFloat(merged.sculptureWetness, 0, 1, defaults.sculptureWetness),
    sculptureDryRoughness: clampFloat(merged.sculptureDryRoughness, 0, 1, defaults.sculptureDryRoughness),
    ...
    seagullFlightActivity: clampFloat(
      merged.seagullFlightActivity,
      0,
      1,
      defaults.seagullFlightActivity,
    ),
    seagullLandingDensity: clampFloat(
      merged.seagullLandingDensity,
      0,
      1,
      defaults.seagullLandingDensity,
    ),
    seagullPointerInteraction: pickBoolean(
      merged.seagullPointerInteraction,
      defaults.seagullPointerInteraction,
    ),
    seagullShootingEnabled: pickBoolean(
    ...
    fishDepthBand: clampFloat(merged.fishDepthBand, 0, 1, defaults.fishDepthBand),
    ...
    cursorEnabled: pickBoolean(merged.cursorEnabled, defaults.cursorEnabled),
    cursorPointSize: clampFloat(merged.cursorPointSize, 3, 12, defaults.cursorPointSize),
    cursorLightEnabled: pickBoolean(merged.cursorLightEnabled, defaults.cursorLightEnabled),
    cursorLightBeamAngle: clampFloat(
      merged.cursorLightBeamAngle,
      12,
      70,
      defaults.cursorLightBeamAngle,
    ),
    cursorLightIntensity: clampFloat(
      merged.cursorLightIntensity,
      0,
      2,
      defaults.cursorLightIntensity,
    ),
    cursorLightSoftness: clampFloat(
      merged.cursorLightSoftness,
      0,
      1,
