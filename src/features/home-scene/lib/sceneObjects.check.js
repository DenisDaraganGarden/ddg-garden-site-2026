...
assert.deepEqual(Object.keys(fresh).sort(), ['algaeVisible', 'boatVisible', 'fishEnabled', 'liliesVisible', 'planeEnabled', 'sculptureVisible', 'seagullsEnabled', 'shoreEnabled', 'tankerVisible'].sort());
