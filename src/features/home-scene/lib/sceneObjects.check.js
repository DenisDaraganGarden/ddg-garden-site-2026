...
assert.deepEqual(Object.keys(fresh).sort(), ['algaeVisible', 'boatVisible', 'fireEnabled', 'fishEnabled', 'liliesVisible', 'sculptureVisible', 'seagullsEnabled', 'shoreEnabled', 'tankerVisible'].sort());
