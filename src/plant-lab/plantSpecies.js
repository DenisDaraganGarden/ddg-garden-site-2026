...
const treeViews={
 ...
 base:{landscape:{position:[1.6,.55,2],target:[0,.5,0]},portrait:{position:[2.2,.8,2.8],target:[0,.6,0]}},
...
export const PLANT_SPECIES={
 oleaster:{
  ...
  planting:{count:[1,512,1],extent:[8,64,1],spacing:1.05},
 ...
 tree:{
  ...
  defaults:{...OLEASTER_DEFAULTS,...TREE_DEFAULTS,dryness:.42,count:14,extent:120,spacing:7,flex:.15},
  ...
  planting:{count:[1,64,1],extent:[24,200,4],spacing:7},
