...
export function grassAssetSettings(source,wind){
 ...
 return {...OLEASTER_DEFAULTS,...ECOLOGY_DEFAULTS,...landscape,dryness:Math.max(0,Math.min(1,landscape.dryness+g.grassDryness)),translucency:.9,roughness:.8,tone:g.grassTone,
