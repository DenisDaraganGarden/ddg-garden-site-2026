  ...
  return (
    <LabShell
      ...
      panel={<>
        ...
        {tab === 'sound' && <>
          <LabSelect label={t.mode} value={settings.audio.mode} onChange={(value) => setAudio('mode', value)} options={['off', 'soundscape'].map((id) => ({ value: id, label: t[id] }))} />
