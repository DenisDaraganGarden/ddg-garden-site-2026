...
export default function AzovTerrain({ definition, settings, qualityProfile, lighting, runtime, rocks, onTerrainReady, audioRuntime, plantCover, swash = null }) {
  ...
  const rockMaterials=useCoastRockMaterials(lowPower,lighting);
  ...
  const materials=useMemo(()=>({land:createTerrainMaterial(textures.maps,createTerrainDefinition())}),[textures]);
