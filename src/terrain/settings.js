...
export const TERRAIN_RANGES = {
  ...
  terrainFeatureScale:[24,160,1], terrainLandslides:[0,1,.01], terrainPaths:[0,1,.01], terrainPathWidth:[.6,4,.1], terrainGroundCover:[0,1,.01], terrainTalus:[0,1,.01], terrainStrata:[0,1,.01], terrainRimWidth:[0,30,.5], terrainRimColor:null, terrainOasis:[0,1,.01], terrainOasisColor:null,
