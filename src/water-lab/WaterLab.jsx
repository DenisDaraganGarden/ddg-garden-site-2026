...
const DEFAULTS = Object.freeze({
  ...
  foamMemory: true, foamLife: 8, foamDeposit: 0.9, foamWindow: 80, foamDrift: 0.4,
...
const PRESETS = {
  calm: { wavelength: 9, amplitude: 0.12, steepness: 0.25, sets: 0.3, crossWaves: 0.3, ripple: 0.5, foamThreshold: 0.3, foamLife: 5, foamDeposit: 0.6, surfHeight: 0.4, surfCurl: 2.5 },
  breeze: { wavelength: 14, amplitude: 0.42, steepness: 0.55, sets: 0.6, crossWaves: 0.5, ripple: 0.35, foamThreshold: 0.55, foamLife: 7, foamDeposit: 0.8, surfHeight: 0.8, surfCurl: 4 },
  rough: { wavelength: 18, amplitude: 0.75, steepness: 0.7, sets: 0.7, crossWaves: 0.6, ripple: 0.35, foamThreshold: 0.6, foamLife: 9, foamDeposit: 0.9, surfHeight: 1.2, surfCurl: 4.4 },
  storm: { wavelength: 26, amplitude: 1.3, steepness: 0.8, sets: 0.5, crossWaves: 0.85, ripple: 0.4, foamThreshold: 0.65, foamLife: 12, foamDeposit: 1.1, surfHeight: 1.8, surfCurl: 4.6 },
};
const VIEWS = {
  ...
  return <main className="water-lab" data-asset-collection="water" lang={language}>
    ...
    <div className="water-lab__workspace"><section className="water-lab__viewer" aria-label="Water viewport">
      <AssetStudio view={view} cameraViews={VIEWS} cameraLimits={LIMITS} cameraFar={6000} fogRange={[1200, 4500]} floorVisible={false} lighting={lighting} exposure={settings.exposure} environmentIntensity={1} paused={paused} inactive={hidden} pixelRatio={[1, 1.5]} background="#a9c8d9" shadowRadius={40}>
        ...
        {settings.surfEnabled ? <BreakingWaves settings={settings} lighting={lighting} noise={noise} shore={SHORE} foamBores={foamBores} /> : null}
