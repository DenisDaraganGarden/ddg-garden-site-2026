...
const buildViews = (BREAK_Q) => ({
  ...
  surfAbove: { landscape: { position: at(BREAK_Q - 30, ALONG_MID, 34), target: at(BREAK_Q + 4, ALONG_MID, 0) }, portrait: { position: at(BREAK_Q - 42, ALONG_MID, 48), target: at(BREAK_Q + 4, ALONG_MID, 0) } },
