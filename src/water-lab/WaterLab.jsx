...
import { breakLineMean, coastBreakLine } from '../components/effects/water/coastFrame';
...
const DEFAULTS = Object.freeze({
  wavelength: 18, amplitude: 0.55, steepness: 0.7, speed: 1, windDirection: 95, sets: 0.6, crossWaves: 0.2, fadeStart: 400, fadeEnd: 2500,
  ...
  surfEnabled: true, surfHeight: 1.1, surfWidth: 9, surfBreakDistance: 0, surfBreakLength: 16, surfLean: 0.45, surfJet: 2.2, surfLift: 0.9, surfSheet: 0.16, surfRoller: 0.5, surfRollerDensity: 1, surfPeel: 0.06, surfRefraction: 0.7, surfBoreLength: 14, surfRunup: 6, surfSpeed: 4.5, surfPeriod: 9, surfSets: 0.5, surfFreeze: false, surfPhase: 0.5,
  ...
  return <main className="water-lab" data-asset-collection="water" lang={language}>
    ...
    <div className="water-lab__workspace"><section className="water-lab__viewer" aria-label="Water viewport">
      <AssetStudio view={view} cameraViews={VIEWS} cameraLimits={LIMITS} cameraFar={6000} fogRange={[1200, 4500]} floorVisible={false} lighting={lighting} exposure={settings.exposure} environmentIntensity={1} paused={paused} inactive={hidden} pixelRatio={[1, 1.5]} background="#a9c8d9" shadowRadius={40}>
        ...
        <Suspense fallback={null}><AzovTerrain definition={DEFINITION} settings={TERRAIN_SETTINGS} qualityProfile={qualityProfile} lighting={lighting} sky={null} runtime={null} rocks={ROCKS} /></Suspense>
