...
const DEFAULTS = Object.freeze({
  ...
  surfEnabled: true, surfHeight: 1.1, surfWidth: 9, surfBreakDistance: 28, surfBreakLength: 16, surfCurl: 4.6, surfLipRadius: 0.7, surfPeel: 0.06, surfBoreLength: 14, surfRunup: 10, surfSpeed: 4.5, surfPeriod: 9, surfSets: 0.5, beachSlope: 2,
...
const PRESETS = {
  calm: { wavelength: 9, amplitude: 0.12, steepness: 0.25, sets: 0.3, crossWaves: 0.3, ripple: 0.5, foamThreshold: 0.3, surfHeight: 0.4, surfCurl: 2.5 },
  breeze: { wavelength: 14, amplitude: 0.42, steepness: 0.55, sets: 0.6, crossWaves: 0.5, ripple: 0.35, foamThreshold: 0.55, surfHeight: 0.8, surfCurl: 4 },
  rough: { wavelength: 18, amplitude: 0.75, steepness: 0.7, sets: 0.7, crossWaves: 0.6, ripple: 0.35, foamThreshold: 0.6, surfHeight: 1.2, surfCurl: 4.4 },
  storm: { wavelength: 26, amplitude: 1.3, steepness: 0.8, sets: 0.5, crossWaves: 0.85, ripple: 0.4, foamThreshold: 0.65, surfHeight: 1.8, surfCurl: 4.6 },
};
const VIEWS = {
  ...
  surfSide: { landscape: { position: [-136, 1.9, SHORE_Z - 27], target: [-100, 0.9, SHORE_Z - 21] }, portrait: { position: [-144, 2.4, SHORE_Z - 27], target: [-100, 0.9, SHORE_Z - 21] } },
...
const COPY = {
  ru: { title: 'Вода · волны и пена', subtitle: 'Герстнер от камеры до горизонта · прибой лентой · пена из облачного шума', waves: 'Волны', surf: 'Прибой', foam: 'Пена', look: 'Вид', light: 'Свет', shore: 'Берег', above: 'Сверху', macro: 'Гребень', surfView: 'Прибой', surfSide: 'Труба', surfAbove: 'Прибой сверху', wavelength: 'Длина волны', amplitude: 'Высота волны', steepness: 'Крутизна', speed: 'Скорость', wind: 'Направление ветра', sets: 'Наборы', cross: 'Поперечные волны', fadeStart: 'Волны гаснут с', fadeEnd: 'Волны гаснут до', ripple: 'Рябь', rippleScale: 'Масштаб ряби', threshold: 'Порог пены', softness: 'Мягкость', lace: 'Масштаб кружева', brightness: 'Яркость пены', water: 'Цвет воды', deep: 'Цвет глубины', glow: 'Просвет гребня', glint: 'Блики солнца', sky: 'Отражение неба', rings: 'Кольца сетки', segments: 'Сегменты сетки', wireframe: 'Каркас', surfEnabled: 'Прибой включён', surfHeight: 'Высота вала', surfWidth: 'Ширина вала', surfBreakDistance: 'Ломается за', surfBreakLength: 'Длина обрушения', surfCurl: 'Закрутка губы', surfLipRadius: 'Радиус трубы', surfPeel: 'Пил вдоль гребня', surfBoreLength: 'Схлопывание', surfRunup: 'Заплеск на песок', surfSpeed: 'Скорость вала', surfPeriod: 'Период', surfSets: 'Разброс высоты', beachSlope: 'Уклон пляжа', time: 'Время суток', bearing: 'Направление солнца', elevation: 'Высота солнца', exposure: 'Экспозиция', pause: 'Пауза', play: 'Продолжить', reset: 'Сброс', calm: 'Штиль', breeze: 'Бриз', rough: 'Волнение', storm: 'Шторм', tri: 'треугольников', calls: 'вызовов', fps: 'кад/с', budget: 'крутизна', assets: 'Коллекции', metres: 'м', hours: 'ч', seconds: 'с', mps: 'м/с', rad: 'рад' },
  en: { title: 'Water · waves and foam', subtitle: 'Gerstner from the camera to the horizon · surf ribbons · foam from the cloud noise', waves: 'Waves', surf: 'Surf', foam: 'Foam', look: 'Look', light: 'Light', shore: 'Shore', above: 'Above', macro: 'Crest', surfView: 'Surf', surfSide: 'Tube', surfAbove: 'Surf above', wavelength: 'Wavelength', amplitude: 'Wave height', steepness: 'Steepness', speed: 'Speed', wind: 'Wind direction', sets: 'Sets', cross: 'Cross waves', fadeStart: 'Waves fade from', fadeEnd: 'Waves fade to', ripple: 'Ripple', rippleScale: 'Ripple scale', threshold: 'Foam threshold', softness: 'Softness', lace: 'Lace scale', brightness: 'Foam brightness', water: 'Water colour', deep: 'Deep colour', glow: 'Crest glow', glint: 'Sun glints', sky: 'Sky reflection', rings: 'Mesh rings', segments: 'Mesh segments', wireframe: 'Wireframe', surfEnabled: 'Surf enabled', surfHeight: 'Breaker height', surfWidth: 'Breaker width', surfBreakDistance: 'Breaks at', surfBreakLength: 'Breaking length', surfCurl: 'Lip curl', surfLipRadius: 'Tube radius', surfPeel: 'Peel along crest', surfBoreLength: 'Collapse', surfRunup: 'Run-up on sand', surfSpeed: 'Breaker speed', surfPeriod: 'Period', surfSets: 'Height variation', beachSlope: 'Beach slope', time: 'Time of day', bearing: 'Sun bearing', elevation: 'Sun elevation', exposure: 'Exposure', pause: 'Pause', play: 'Resume', reset: 'Reset', calm: 'Calm', breeze: 'Breeze', rough: 'Rough', storm: 'Storm', tri: 'triangles', calls: 'draw calls', fps: 'fps', budget: 'steepness', assets: 'Collections', metres: 'm', hours: 'h', seconds: 's', mps: 'm/s', rad: 'rad' },
};
...
export default function WaterLab() {
  ...
  const swellShore = useMemo(() => (settings.surfEnabled ? { origin: [0, SHORE_Z], shoreDir: [0, 1], fadeN: -settings.surfBreakDistance - 6, fadeWidth: 30 } : null), [settings.surfBreakDistance, settings.surfEnabled]);
  ...
  return <main className="water-lab" data-asset-collection="water" lang={language}>
    ...
    <div className="water-lab__workspace"><section className="water-lab__viewer" aria-label="Water viewport">
      <AssetStudio view={view} cameraViews={VIEWS} cameraLimits={LIMITS} cameraFar={6000} fogRange={[1200, 4500]} floorVisible={false} lighting={lighting} exposure={settings.exposure} environmentIntensity={1} paused={paused} inactive={hidden} pixelRatio={[1, 1.5]} background="#a9c8d9" shadowRadius={40}>
        <GerstnerWaterSurface settings={settings} lighting={lighting} noise={noise} wireframe={settings.wireframe} shore={swellShore} />
        {settings.surfEnabled ? <BreakingWaves settings={settings} lighting={lighting} noise={noise} shore={SHORE} /> : null}
        {settings.surfEnabled ? <Beach slopeDeg={settings.beachSlope} /> : null}
        <LabStats onStats={setStats} />
      </AssetStudio>
      <div className="water-lab__views" role="group" aria-label="Ракурс">{['shore', 'above', 'macro', 'surf', 'surfSide', 'surfAbove'].map((id) => <button key={id} aria-pressed={view === id} onClick={() => setView(id)}>{viewLabel(id)}</button>)}</div>
      ...
      <div className="water-lab__controls" role="tabpanel" aria-label={t[tab]}>
        ...
        {tab === 'surf' && <><Toggle label={t.surfEnabled} value={settings.surfEnabled} onChange={(value) => set('surfEnabled', value)} />{range('surfHeight', t.surfHeight, 0.2, 3, 0.05, t.metres)}{range('surfWidth', t.surfWidth, 3, 24, 0.5, t.metres)}{range('surfBreakDistance', t.surfBreakDistance, 5, 80, 1, t.metres)}{range('surfBreakLength', t.surfBreakLength, 4, 40, 1, t.metres)}{range('surfCurl', t.surfCurl, 0, 5.5, 0.05, t.rad)}{range('surfLipRadius', t.surfLipRadius, 0.2, 1.2, 0.02)}{range('surfPeel', t.surfPeel, 0, 0.6, 0.01)}{range('surfBoreLength', t.surfBoreLength, 3, 40, 1, t.metres)}{range('surfRunup', t.surfRunup, 0, 30, 1, t.metres)}{range('surfSpeed', t.surfSpeed, 1, 10, 0.1, t.mps)}{range('surfPeriod', t.surfPeriod, 3, 20, 0.5, t.seconds)}{range('surfSets', t.surfSets, 0, 1, 0.01)}{range('beachSlope', t.beachSlope, 0.5, 8, 0.1, '°')}</>}
